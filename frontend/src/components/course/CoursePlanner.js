            ...
            <div>
                {selectedForm === 'New Course' ? (
                    ...
                    <div>
                        ...
                        <EditCourseForm courses={courses} teachers={teachers} fetchCourseInfo={fetchCourseInfo} editedCourseData={editedCourseData} setEditedCourseData={setEditedCourseData} />
                    </div>
                )}
            </div>
        </div>
